...
$CONTROL->handler($Request['method'], $Request['table'], $Request['returnType'], $Request['schema'], (object) json_decode($Request['data']), $Request['route']);
...
// 		$result = $GET->route($Request['method'], $Request['table'], $Request['returnType'], $Request['schema'], (object) json_decode($Request['data']), $Request['route']);
// 		$Res->sendData($result);
// 		break;
